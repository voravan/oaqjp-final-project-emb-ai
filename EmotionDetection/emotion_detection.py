...
def emotion_detector(text_to_analyse):
    ...
    # Task 7: Incorporate Error Handling (Status code 400 validation)
    ...
    # Task 7: Check if the request failed with status code 400
    ...
    # Find the dominant emotion programmatically
    emotion_dict = {
        'anger': anger_score,
